...
class ChatSettingsFragment : PreferenceFragmentCompat(), ISettingsView {
    ...
    override fun onCreatePreferencesFix(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        rate.setOnPreferenceClickListener {
            startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=" + PACKAGE_NAME)))
            true
        }
            ...
            try {
                ...
                shareIntent.putExtra(Intent.EXTRA_TEXT,
                        String.format(getString(R.string.promo_msg_template),
                                String.format(getString(R.string.app_share_url), PACKAGE_NAME)))
